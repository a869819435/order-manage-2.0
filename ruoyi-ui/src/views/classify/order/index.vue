  ...
  <div class="app-container">
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="父级id" prop="parentId">
          <treeselect v-model="form.parentId" :options="orderOptions" :normalizer="normalizer" placeholder="请选择父级id" />
        </el-form-item>
        <el-form-item label="层级" prop="level">
...
<script>
import { listOrder, getOrder, delOrder, addOrder, updateOrder, exportOrder } from "@/api/classify/order";
...
export default {
  ...
  methods: {
    ...
    /** 删除按钮操作 */
    handleDelete(row) {
      this.$confirm('是否确认删除工单分类编号为"' + row.id + '"的数据项?', "警告", {
