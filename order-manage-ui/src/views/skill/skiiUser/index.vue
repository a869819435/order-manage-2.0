<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="skiiUserList" @selection-change="handleSelectionChange">
      <el-table-column type="selection" width="55" align="center" />
      <el-table-column label="主键" align="center" prop="id" />
      <el-table-column label="技能主键" align="center" prop="skillId" />
      <el-table-column label="技能名称" align="center" prop="skillName" />
      <el-table-column label="技能熟练度" align="center" prop="skillLevel" />
      <el-table-column label="技能拥有人" align="center" prop="skillerId" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="620px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="120px">
        <el-form-item label="技能主键" prop="skillId">
          <el-input v-model="form.skillId" placeholder="请输入技能主键" />
        </el-form-item>
        <el-form-item label="技能名称" prop="skillName">
        ...
        <el-form-item label="技能拥有人" prop="skillerId">
          <el-input v-model="form.skillerId" placeholder="请输入技能拥有人" />
        </el-form-item>
...
<script>
import { listSkiiUser, getSkiiUser, delSkiiUser, addSkiiUser, updateSkiiUser, exportSkiiUser } from "@/api/skill/skiiUser";
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$confirm('是否确认删除技能-技师信息编号为"' + ids + '"的数据项?', "警告", {
