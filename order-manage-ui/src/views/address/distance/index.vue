    ...
    <el-dialog :title="title" :visible.sync="open" width="620px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="120px">
        <el-form-item label="出发地" prop="codeX">
          <!-- <el-input v-model="form.codeX" type="hidden"  /> -->
          <!-- filterable:开启过滤，即搜索 -->
          <el-select
            filterable
            v-model="form.codeX"
        ...
        <el-form-item label="目的地" prop="codeY">
          <!-- filterable:开启过滤，即搜索  clearable:开启清楚文本框的叉叉-->
          <el-select
            filterable
            v-model="form.codeY"
        ...
        <el-form-item label="相差距离(km)" prop="distance">
          <el-input v-model="form.distance" placeholder="请输入相差距离(km)" />
        </el-form-item>
...
export default {
  ...
  data() {
    return {
      ...
      // 表单校验
      rules: {
        codeX: [{ required: true, message: "出发地不能为空", trigger: "blur" }],
        codeY: [{ required: true, message: "目的地不能为空", trigger: "blur" }],
        distance: [
